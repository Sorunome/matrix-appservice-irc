...
var PonyMotes = jsonfile.readFileSync('./ponymotes_clean.json');
...
IrcBridge.prototype.getMatrixUser = Promise.coroutine(function*(ircUser) {
    ...
    var avatarUrl = "mxc://ponies.im/bpm."+PonyMotes[Math.floor(Math.random()*PonyMotes.length)];
    console.log(avatarUrl);
    yield userIntent.setAvatarUrl(avatarUrl); // set a random avatar url
